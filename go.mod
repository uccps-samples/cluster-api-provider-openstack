...
require (
	...
	github.com/uccps-samples/machine-api-operator v0.0.0-20221025062916-4d3848406115
...
require (
	...
	github.com/uccps-samples/library-go v0.0.0-20221025021912-5a8f5fc3479f // indirect
...
replace golang.org/x/sys => github.com/loongson/sys v0.0.0-20211022032851-442ec7e848c8
